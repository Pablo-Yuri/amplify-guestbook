...
const messages: Message[] = [
  {
    ...
    text: 'Olá, Hack the Cloud!',
    createdAt: new Date().toISOString(),
    likes: 3
  },
  {
    id: '2',
    user: 'etc@hackthecloud.unb',
    text: 'Mensagem mocada!',
    createdAt: new Date().toISOString(),
    likes: 1
  },
  {
    id: '3',
    user: 'etc2@hackthecloud.unb',
    text: 'Mensagem mocada 2!',
    createdAt: new Date().toISOString(),
    likes: 5
  }
]
  ...
  <div class="min-h-screen w-full bg-linear-to-b from-amber-50 via-white to-emerald-50 text-slate-800 flex flex-col">
    <main class="mx-auto w-full max-w-6xl px-4 py-10 space-y-10 flex-1">
      <section class="text-center space-y-4">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold text-slate-900">Mural de Assinaturas</h1>
        <p class="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto">
          Adicione sua assinatura no Hack The Cloud UNB 2025! 
        </p>
        <div class="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto">
            Envie uma mensagem para o mural e curta as mensagens dos outros participantes.
        </div>
